...
player_class = {
    'rogue': {
        'name': 'лучник',
        'img': '1030494/48c262cd6cac2b0e763a',
    },
    'warrior': {
        'name': 'воин',
        'img': '1030494/44bdf189f002e3c1ccb4',
    },
    'mage': {
        'name': 'маг',
        'img': '937455/eb3fb3d2a57220b1761b',
    }
}

enemy_list = [
    {'name': 'Гоблин', 'img': '213044/0c9d4b55f7bbeb2ddda1'},
    {'name': 'Тролль', 'img': '213044/3ea0f2623807abc72bf9'},
    {'name': 'Оборотень', 'img': '213044/08f39ea46d34d09bcd14'},
]
        ...
        if entity['type'] == 'YANDEX.FIO':
            if name := entity['value'].get('first_name'):
                ...
                res['response']['card'] = {
                    'type': "ItemsList",
                    "header": {
                        "text": f"Приятно познакомиться {name}, выбери свой классс"
                    },
                    "items": [
                        {
